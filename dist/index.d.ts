...
import {
  _ as _RefWithState,
  a as _Simplify,
  b as _DataSourceOptions,
  R as ResetOption,
  c as _Nullable,
  d as _FirestoreDataSource,
} from './shared/vuefire.cc4a8ea4.js'
 ...
 * @internal
 */
interface _DatabaseRefOptions<DataT = unknown>
 ...
 */
declare function useDatabaseList<T = unknown>(
 ...
 * @param options - optional options
 */
declare function useDatabaseObject<T = unknown>(
 ...
 */
interface FirestoreRefOptions<TData = unknown>
...
interface _UseFirestoreRefOptions<TData = unknown>
 ...
 * @internal
 */
type _InferReferenceType<R> = R extends
...
declare function useCollection<
  R extends CollectionReference<unknown> | Query$1<unknown>,
>(
 ...
 * @param options - optional options
 */
declare function useCollection<T>(
  collectionRef: MaybeRefOrGetter<
    _Nullable<CollectionReference<unknown> | Query$1<unknown>>
  >,
 ...
 * @param options - optional options
 */
declare function useDocument<R extends DocumentReference<unknown>>(
 ...
 * @param options - optional options
 */
declare function useDocument<T>(
...
declare const devalueCustomStringifiers: {
  TimeStamp: (data: unknown) =>
    | false
    | {
        seconds: number
        nanoseconds: number
      }
  GeoPoint: (data: unknown) =>
    | false
    | {
        latitude: number
        longitude: number
 ...
 * @param pluginOptions
 */
declare function databasePlugin(
  app: App,
 ...
 * ```
 */
declare function VueFireDatabaseOptionsAPI(
  pluginOptions?: DatabasePluginOptions
 ...
 * ```
 */
declare function VueFireFirestoreOptionsAPI(
  pluginOptions?: FirestorePluginOptions
): (firebaseApp: FirebaseApp, app: App) => void
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    $firestoreBind<T = DocumentData>(
      name: string,
      reference: Query$1<T> | CollectionReference<T>,
 ...
 * @param name - name of the application
 */
declare function useIsCurrentUserLoaded(
  name?: string
): vue_demi.ComputedRef<boolean>
/**
 ...
 */
declare function VueFireAuthOptionsFromAuth({
  auth,
  initialUser,
 ...
 */
declare function VueFireAuthWithDependencies({
  dependencies,
  initialUser,
 ...
 * @internal
 */
declare function _VueFireAuthInit(
  firebaseApp: FirebaseApp,
  app: App,
  initialUser: _Nullable<User>,
  dependencies?: Dependencies,
  ...
  vue_demi.Ref<
    | {
        ...
        ) => Promise<firebase_auth.IdTokenResult>
        reload: () => Promise<void>
        toJSON: () => object
        readonly displayName: string | null
        readonly email: string | null
 ...
 */
declare function usePendingPromises(
  app?: FirebaseApp
 ...
 */
declare function useSSRInitialState(
 ...
 * ```
 */
declare function VueFireAppCheck(
 ...
 * @returns the Database instance
 */
declare function useFirebaseStorage(
  name?: string
 ...
 */
declare function useStorageFileUrl(
 ...
 * @param storageRef - StorageReference
 */
declare function useStorageFileMetadata(
  storageRef: MaybeRefOrGetter<_Nullable<StorageReference>>
): {
  metadata: vue_demi.ShallowRef<
    FullMetadata | null | undefined,
    FullMetadata | null | undefined
  >
  update: (newMetadata: SettableMetadata) => Promise<FullMetadata | null>
  refresh: () => Promise<FullMetadata | null>
  promise: vue_demi.ShallowRef<
 ...
 * @param storageRef - StorageReference
 */
declare function useStorageFile(
  storageRef: MaybeRefOrGetter<_Nullable<StorageReference>>
): {
  url: vue_demi.Ref<string | null | undefined, string | null | undefined>
  metadata: vue_demi.ShallowRef<
    ...
    FullMetadata | null | undefined
  >
  snapshot: vue_demi.ShallowRef<
    UploadTaskSnapshot | null | undefined,
    UploadTaskSnapshot | null | undefined
  >
  uploadTask: vue_demi.ShallowRef<
    UploadTask | null | undefined,
    UploadTask | null | undefined
  >
  uploadError: vue_demi.ShallowRef<
    StorageError | null | undefined,
    StorageError | null | undefined
  >
...
export {
  ...
  type DatabaseSnapshotSerializer,
  type FirebaseOption,
  type FirestoreOption,
  type FirestorePluginOptions,
  type UseCollectionOptions,
  type UseDatabaseRefOptions,
