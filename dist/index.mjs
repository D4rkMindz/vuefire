import {
  i as isFirestoreDataReference,
  a as isFirestoreQuery,
  b as isDatabaseReference,
  c as isStorageReference,
  n as noop,
  u as useFirebaseApp,
  d as isObject,
  e as checkWrittenTarget,
  f as useIsSSR,
  g as isPOJO,
  h as isDocumentRef,
  w as walkGet,
  j as callOnceWithArg,
  k as walkSet,
  l as getGlobalScope,
  s as setupOnAuthStateChanged,
  m as authUserMap,
  o as isClient,
  _ as _FirebaseAppInjectionKey,
} from './shared/vuefire.0feb90cc.mjs'
export {
  V as VueFireAppCheck,
  r as getCurrentUser,
  t as updateCurrentUserProfile,
  x as useAppCheck,
  v as useAppCheckToken,
  p as useCurrentUser,
  q as useIsCurrentUserLoaded,
} from './shared/vuefire.0feb90cc.mjs'
import {
  toValue,
  ref,
